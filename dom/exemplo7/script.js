...
Modelo Objeto do Documento
*/

window.alert();
window.prompt();
//window.document.getElementById("nomeDoID");
//window.document.body.style.background;
//window.document.head.title;
...
//tipos de dados fundamentais (Interfaces)
// document ->document
//node (nó) (nao eh o node que testa o js)
//Element
//NodeList
//Attribute
